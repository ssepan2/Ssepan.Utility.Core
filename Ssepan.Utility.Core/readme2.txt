...
2.3
~In Ssepan.Utility.Core, added Cast method to ObjectHelper class to help with casting to anonymous types.
...
~Ssepan.Utility.Core to fix log writing to include a fixed source of Ssepan.Utility.Core and put the calling source into the description.
